...
class Line(object):
    ...
    def __init__(self, start, end):
        ...
        self.end = Point(end.x,end.y)  # Not best way to do it.
        self.count = 0
        self.start1 = Point(0,0)
        self.start2 = Point(0,0)
        self.end1 = Point(0,0)
        self.end2 = Point(0,0)
        self.start_clone = self.start.clone()
        self.end_clone = self.end.clone()
    ...
    def clone(self):
        ...
        return Line(self.start_clone,self.end_clone)
    ...
    def line_plus(self, other_line):
        ...
        # ---------------------------------------------------------------------
        start1 = self.start
        start2 = other_line.start
        end1 = self.end
        end2 = other_line.end
        new_start = start1.plus(start2)
        new_end = end1.plus(end2)
    ...
    def line_minus(self, other_line):
        ...
        end1 = self.end
        end2 = other_line.end
        new_start = start1.minus(start2)
        new_end = end1.minus(end2)
        return Line(new_start,new_end)
    ...
    def reset(self):
        ...
        #        They include the Example in the above doc-string.
        # ---------------------------------------------------------------------
        self.start = self.start_clone
        self.end = self.end_clone
